...
```{r, echo=FALSE, fig.cap="", out.width = '70%'}
knitr::include_graphics("data/ira2020-messy.PNG")
```
...
knitr::include_graphics("data/covid2020-tidy.PNG")
```
...
```{r, echo=FALSE, fig.cap="", out.width = '70%'}
knitr::include_graphics("data/eda2020-messy.PNG")
```
...
```{r, echo=FALSE, fig.cap="", out.width = '90%'}
knitr::include_graphics("data/gapminder-tidy.PNG")
```
...
1. **Mapear x: "Fecha" y: "Grupo de Edad" fill: "Casos"**
...
## ¡Detallitos de nivel intermedio!
...
---
.left-code[
### Sobre la Tarea 1.7. Agregar escala de color viridis.
...
1. **Comentar: ¿En qué se diferencia con el gráfico de la tarea 1.7? ¿Cuál prefieres?**
...
1. **Cambiar la geometría con el método de Regresión Lineal `geom_smooth(method="lm")`**
1. **Comentar: ¿En qué se diferencian? ¿Cuál prefiere?**
...
---
.left-code[
### Grafique un __Diagrama de Puntos y Tendencia con Media Móvil de 7 días__ según "Fecha"
...
1. **Comentar: ¿En qué se diferencian tarea 2.1 y 2.2?**
...
---
.left-code[
### Grafique un __Diagrama de Líneas__ con casos incidentes por "Fecha" por Departamentos. Escala eje Y por log10. Agrega una regresión lineal a cada uno.

1. _Retirar_ filas con edades negativas.
1. _Contar_ casos por fecha y departamento.
1. **Mapear x: "Fecha" y: "Casos" by: "Departamento"**
1. **Usar la geometría `geom_point()`**
...
# <!-- library(cowplot) -->
# 
# <!-- p1 <- ggplot(pinguinos, aes(disp, pinguinos)) +  -->
# <!--   geom_point() -->
# <!-- p2 <- ggplot(pinguinos, aes(qsec, pinguinos)) + -->
# <!--   geom_point() -->
# 
...
# <!-- gg_point <-   -->
# <!--   ggplot(pinguinos,  -->
# <!--          aes(bill_length_mm, bill_depth_mm, color=bill_depth_mm)) + -->
# <!--   theme_minimal() + -->
